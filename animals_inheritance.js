...
console.log('animal' + ': species => ' +animal.species + ' / can fly => ' + animal.can_fly  + ' / suck blood => ' + animal.suck_blood);
console.log('bat' + ': species => ' +bat.species + ' / can fly => ' + bat.can_fly + ' / suck blood => ' + bat.suck_blood + '\n');
